...
$post_type_registrations = new SSM_FAQs_Registrations;

// Instantiate main plugin file, so activation callback does not need to be static.
$post_type = new SSM_FAQs( $post_type_registrations );
...
if ( is_admin() ) {
	...
	$post_type_admin = new SSM_FAQs_Admin( $post_type_registrations );
